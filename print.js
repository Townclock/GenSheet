...
"I/V": { mod: 0, print: (key) => keys[key]+"/"+keys[key+7], scale:[]},
...
"IMaj/5": { mod: 0, print: (key) => keys[key]+"/"+keys[key+7], scale: majorPentatonic},
...
"V/IV" : { mod: 7, print: (key) => keys[key]+"/"+keys[key+6], scale: majorPentatonic},  //bleh
